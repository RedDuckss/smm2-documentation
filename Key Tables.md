Key tables are used in ENL to generate crypto keys used to encrypt and decrypt contents. These are the key tables used by Super Mario Maker 2

### Course

Used for course bcd files
